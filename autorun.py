...
if path_get != -1:
    while 1:
        command_select = input(
            'Do you want to autostart the sound version or the Test version(without OpenCV)?\nInput "1" to select '
    ...
    print(
        "Cannot find the programe for this robot, you need to setup the programe first."
    )
